...
void printUsage() {
    printf("Usage:\n  ./app <serial port> <actor>\nWhere <serial port> is the 'x' in:\n/dev/ttySx\nAnd <actor> is either RECEIVER or TRANSMITTER.\nWhen <actor> is TRANSMITTER you can add two optional arguments: <fileToSend> <destFileName>, which need to come in this order after the mandatory arguments.\nYou can also specify frame size (-t) and baudrate (-b). Be sure that these values match in the RECEIVER and the TRANSMITTER.\nBaudrate can be one of the following:\n4800\n9600\n19200\n38400\n57600\n115200\n230400\n");
    exit(EXIT_FAILURE);
}
